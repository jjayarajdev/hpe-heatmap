            ...
            with st.spinner("🤖 AI analyzing requirements..."):
                try:
                    ...
                    if 'resource_DETAILS_28_Export_clean_clean' in data:
                        ...
                        st.markdown("<div style='text-align: center;'><h3>✅ AI Analysis Complete!</h3></div>", unsafe_allow_html=True)
                        
                        # Center the skills and services results
                        col_spacer1, col_results, col_spacer2 = st.columns([1, 8, 1])
                        ...
                        if recommendations:
                            for i, rec in enumerate(recommendations, 1):
                                ...
                                # Resource details using CORRECT field mapping
                                col_left, col_right = st.columns(2)
                                
                                with col_left:
                                    # Get skills from matching_skills or profile
                                ...
                                with col_right:
                                    ...
                                    practice = rec.get('practice', 'N/A')
                                    
                                    st.write(f"**📍 Location:** {location}")
                                    st.write(f"**👤 Manager:** {manager}")
                                    st.write(f"**🏢 Practice:** {practice}")
